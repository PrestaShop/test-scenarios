...
* **[tests/UI/campaigns/functional/API/02_endpoints/discount/01_getDiscountTypes.ts](https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/discount/01_getDiscountTypes.ts)** :
  * [PrestaShop#42209 : [FF Discounts] Discount Type has an available type "order_level" but unavailable on UI](https://github.com/PrestaShop/PrestaShop/issues/42209)

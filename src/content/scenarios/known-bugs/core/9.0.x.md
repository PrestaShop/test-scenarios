...
* **[tests/UI/campaigns/functional/API/02_endpoints/02_attributesGroup/06_getAttributesGroups.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/02_attributesGroup/06_getAttributesGroups.ts)** :

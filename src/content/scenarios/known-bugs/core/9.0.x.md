...
* **[tests/UI/campaigns/functional/API/02_endpoints/04_hook/03_getHooks.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/04_hook/03_getHooks.ts)** :

...
* **[tests/UI/campaigns/functional/API/02_endpoints/08_product/09_patchProductId.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/08_product/09_patchProductId.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/08_product/11_getProductsSearch.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/08_product/11_getProductsSearch.ts)** :

...
* **[tests/UI/campaigns/functional/API/02_endpoints/02_attribute/04_postAttributesAttribute.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/02_attribute/04_postAttributesAttribute.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/02_attribute/10_postAttributesGroup.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/02_attribute/10_postAttributesGroup.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/02_attribute/12_getAttributesGroups.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/02_attribute/12_getAttributesGroups.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/03_category/05_deleteCategoryId.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/03_category/05_deleteCategoryId.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/05_hook/03_getHooks.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/05_hook/03_getHooks.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/08_product/08_patchProductId.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/08_product/08_patchProductId.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/08_product/10_getProductsSearch.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/08_product/10_getProductsSearch.ts)** :
...
* **[tests/UI/campaigns/functional/BO/03_catalog/07_discounts/01_cartRules/01_CRUDCartRule/02_conditions/10_compatibilityWithOtherCartRules.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/BO/03_catalog/07_discounts/01_cartRules/01_CRUDCartRule/02_conditions/10_compatibilityWithOtherCartRules.ts)** :
  * [PrestaShop#39929 : Updating its adress (without changing it) update some prices](https://github.com/PrestaShop/PrestaShop/issues/39929)

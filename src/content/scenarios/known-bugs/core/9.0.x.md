...
* **[tests/UI/campaigns/functional/API/02_checkEndpoints.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_checkEndpoints.ts)** :
  * Scenario & UI Test
* **[tests/UI/campaigns/functional/API/02_endpoints/03_hook/01_putHookStatusId.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/03_hook/01_putHookStatusId.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/03_hook/02_getHooks.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/03_hook/02_getHooks.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/06_product/08_patchProductId.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/06_product/08_patchProductId.ts)** :
...
* **[tests/UI/campaigns/functional/API/02_endpoints/06_product/10_getProductsSearch.ts](https://github.com/PrestaShop/PrestaShop/tree/9.0.x/tests/UI/campaigns/functional/API/02_endpoints/06_product/10_getProductsSearch.ts)** :

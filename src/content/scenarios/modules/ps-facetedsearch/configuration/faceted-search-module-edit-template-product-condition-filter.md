...
| Go to the "Options" tab > "condition & References" section > Change the value of "Condition" field from "New" ti "Used" > Check "Display condition on product page" checkbox >  Click on "Save" button | * "Condition" is changed in the drop list <br> * "Display condition on product page" is checked <br> * You have a blue modal with "Settings updated" |

...
| Go to FO > Product page > Add your email address in Notify me when available | Request notification registered message is displayed |
| View Order > Click on Return products > Check Quantity : 1 > Return products | The product was successfully returned. message is displayed |
| Check your emails | Email titled Product available is sent to registered user hello@world.com |
| Go to BO > Edit product > Quantity change to 0 > Save | Successful update message is displayed |
| Go to FO > Product page > Add your email address in Notify me when available | Request notification registered message is displayed |
| Go to BO > Catalog > Stock > Check Display products below low stock level first > Add quantity to your product with no stock > Click Apply new quantity | Stock successfully updated message is displayed<br><br>Check the email : Email titled Product available is sent to registered user |

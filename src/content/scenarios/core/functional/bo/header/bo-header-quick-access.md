...
* **Component** : Core
* **Status** : Automated
* **Automated on** : 1.7.8.x, 8.0.x, 8.1.x, 9.0.x, 9.1.x, 9.2.x, 9.3.x
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-7486
...
| Click on edit button next to previously quick access created > <br>Enable "New window" option and clic on save | Option is enabled<br>"The status has been successfully updated." is displayed |

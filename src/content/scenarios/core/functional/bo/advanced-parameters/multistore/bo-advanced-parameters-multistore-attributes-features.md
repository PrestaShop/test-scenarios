...
| Go to BO > Catalog > Attributes & Features | Attributes Page displayed |
| Change context | Attributes Page displayed |
| Change context | Attributes Page displayed |
| Go to Features Tab | Feature Page displayed |
| Change context | Feature Page displayed |
| Change context | Feature Page displayed |

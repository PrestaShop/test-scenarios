...
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8341
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/BO/14_advancedParameters/12_adminAPI/03_editAPIClient.ts
...
| ----- | ----- |
| In BO, Go to Advanced Parameters > Admin API | Admin API Page is displayed correctly.<br>1 record found in the table |
| On the first row, click on the edit button | Edit API Client Page is displayed correctly |
...
| In BO, Go to Advanced Parameters > Admin API | Admin API Page is displayed correctly.<br>1 record found in the table<br>The API Client on the first row is disabled |
| On the first row, click on the edit button | Edit API Client Page is displayed correctly |
| Enable the application | The message “Successful update” is displayed<br><br>Check that data are well filled |
| In BO, Go to Advanced Parameters > Admin API | Admin API Page is displayed correctly.<br>1 record found in the table<br>The API Client on the first row is enabled |
| On the first row, click on the edit button | Edit API Client Page is displayed correctly |

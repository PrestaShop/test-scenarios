...
| Set these fields:<br> * Information:<br> * Name<br> * Description<br> * Status = *Enabled*<br> * Actions:<br> * Gift = a demo product<br><br>and click on Save | The pop up is no more displayed |
...
| Set these fields:<br> * Information:<br> * Name<br> * Description<br> * Status = *Enabled*<br> * Actions:<br> * Free shipping<br><br>and click on Save | The pop up is no more displayed |
| Click on it | In the Vouchers block, check that a cart rule line is well displayed and check that<br> # Name => ok<br> # Description => ok<br> # Value === 0 |

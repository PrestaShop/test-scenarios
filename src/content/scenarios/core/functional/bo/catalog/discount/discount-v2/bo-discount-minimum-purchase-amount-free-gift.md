...
| Fill form and save | Discount page displayed<br><br>The form contains errors. Please fix them and save again.<br><br>Error Message: The field names is required at least in your default language. |
| Fill form and save | Discount page displayed<br><br>The form contains errors. Please fix them and save again.<br>No product selected<br>Error Message: This value should not be blank. |
| Fill form and save | Discount page displayed<br><br>Error Message: The form contains errors. Please fix them and save again.<br>Error Message: This value should be greater than 0. |
| Fill form and save | Discount page displayed<br><br>Error Message: The form contains errors. Please fix them and save again.<br>Error Message: This value should be greater than 0. |
| Fill form and save | Discount page displayed<br><br>Error Message: Please enter a valid money amount. |
| Fill form and save | Discount page displayed<br><br>Message: Successful creation |

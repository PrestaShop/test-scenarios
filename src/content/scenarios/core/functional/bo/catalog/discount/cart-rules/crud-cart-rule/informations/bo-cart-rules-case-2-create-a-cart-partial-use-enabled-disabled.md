...
| Click on Continue and Place the order | The Order History is displayed |
...
| Reset Filter and Filter by Name | The list contains the serached vouchers |
...
| Click on "Proceed to checkout" and place order | The Order History is displayed |

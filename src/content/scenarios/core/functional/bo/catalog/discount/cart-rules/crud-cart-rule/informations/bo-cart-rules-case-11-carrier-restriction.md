...
| Create a new discount, set these fields:<br> # Information:<br>1. Name<br>2. Description<br>3. Code<br> # Conditions:<br>1.Select Carrier: PrestaShop unselected carrier + My carrier selected carriers<br> # Actions:<br>1. Discount = 100 Euro tax included<br><br>and click on Save | An alert "Successful update." is displayed |

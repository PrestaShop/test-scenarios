...
| Fill the main fields on "Description" tab > Click on *Save and publish* button | * "Product image" uploaded with image<br> * "Product name" field filled with "my product"<br> * "Summary" field filled with "summary"<br> * "Description" field filled with "description" |
| Go to the "Combinations" tab > Click on "Attributes & Features" link | The page "Attributes " is displayed in another tab |
| * Return in BO > Catalog > Products <br> * Clic on your new product | * All product should be displayed<br> * The page of your product with the description is displayed |

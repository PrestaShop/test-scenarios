...
| Fill the blanks of the second step "Size weight and group acces  " then click on next | the data is saved  .<br><br>the color of the third    step is changed to green .<br><br>the content is changing to the fourth step "Summary  " where there are the informations of the carrier created <br><br>the status of the carrier is enabled . |
| Click on Finish | * A green alert "Successful creation " is displayed<br> * <br>a new carrier is well displayed on the list |
| Click on the button  of edit | the page of editing is displayed with the logo  and the informations of the fourth steps  . |
...
| on the dropdown button click on delete | a popup message is displayed : <br><br>Delete selected item? <br><br>Name : new_test <br><br>YES or NO buttons |

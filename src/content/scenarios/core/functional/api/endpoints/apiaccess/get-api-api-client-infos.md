...
| Request with method GET the endpoint "https://[url of your shop]/admin-dev/index.php/api/api-access/infos" | The return value is in JSON.<br><br>The return data has multiples keys : "apiClientId", "clientId", "clientName", "description", "enabled", "lifetime", "scopes"<br><br>The return data keys are consistent relative to BackOffice data. |

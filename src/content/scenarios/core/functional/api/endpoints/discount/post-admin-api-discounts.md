...
* **Status** : Automated
* **Automated on** : 9.2.x
* **Scenario** : https://forge.prestashop.com/browse/TEST-12881
...
| Filter by ID with the ID of the created discount | 1 record found |
...
| In BO, Go to Catalog > Discounts | Discounts Page is displayed correctly. |
| Filter by groupe ID with the ID of the created discount | 1 record found |
| Delete the filtered discount > Click Yes | Message “Successful deletion” is displayed<br><br>The filtered discount is deleted |
| Reset all filters of Discounts table | All filters are reset. <br>All Discounts are displayed |
| In BO, Go to Advanced Parameters > New & Experimental Features | New & Experimental Features is displayed correctly |

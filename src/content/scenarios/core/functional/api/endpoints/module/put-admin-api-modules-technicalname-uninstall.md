...
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8404
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/07_module/06_putModulesTechnicalNameUninstall.ts
...
| Request with method POST the endpoint "https://[url of your shop]/admin-api/modules/\{technicalName}/uninstall" with data<br><br>Where technicalName = keycloak_connector_demo | The HTTP code is 204 |

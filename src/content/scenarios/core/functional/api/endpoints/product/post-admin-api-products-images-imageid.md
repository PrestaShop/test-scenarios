---
title: "POST /admin-api/products/images/{imageId}"
weight: 7
---

# POST /admin-api/products/images/{imageId}
## Details
* **Component** : Core
* **Status** : Automated
* **Automated on** : 9.0.x, 9.1.x, 9.2.x, 9.3.x
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8381
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/07_product/02_postProductsImagesId.ts
...
| Request with method POST the endpoint "https://[url of your shop]/admin-api/products/images/\{imageId} " where \{imageId} is the imageId ID get | The HTTP Code is 201.<br><br>The return value is in JSON.<br><br>The return data has multiples keys : "imageId", "imageUrl", "thumbnailUrl", "legends", "cover", "position", "shopIds" |

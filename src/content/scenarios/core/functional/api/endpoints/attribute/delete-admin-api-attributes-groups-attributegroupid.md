...
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8468
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/02_attributesGroup/01_deleteAttributesGroupsId.ts
...
| Request with method DELETE the endpoint "https://[url of your shop]/admin-api/attributes/groups/\{attributeGroupId}" | The HTTP code is 204. |

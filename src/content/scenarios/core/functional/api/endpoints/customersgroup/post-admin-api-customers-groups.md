...
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8427
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/03_customerGroup/04_postCustomersGroups.ts
...
| Request with method POST the endpoint "https://[url of your shop]/admin-api/customers/groups" with relative data | The HTTP code is 201.<br><br>The return value is in JSON<br><br>The return value data are consistent relative to sent data. |

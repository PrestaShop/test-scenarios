...
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-8364
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/04_customerGroup/03_putCustomersGroupsId.ts
...
| Request with method PUT the endpoint "https://[url of your shop]/admin-api/customers/groups/\{customerGroupId}" with modified data (relative to  the data used for the creation) | The HTTP code is 200.<br><br>The return value is in JSON<br><br>The return value data are consistent relative to sent data. |

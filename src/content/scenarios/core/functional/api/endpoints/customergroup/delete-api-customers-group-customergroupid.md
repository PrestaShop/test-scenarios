---
title: "DELETE /api/customers/group/{customerGroupId}"
weight: 1
---

# DELETE /api/customers/group/{customerGroupId}
## Details
* **Component** : Core
* **Status** : Automated
* **Automated on** : 9.0.x
...
| Request with method DELETE the endpoint "https://[url of your shop]/admin-dev/index.php/api/customers/group/\{customerGroupId}" | The HTTP code is 204. |

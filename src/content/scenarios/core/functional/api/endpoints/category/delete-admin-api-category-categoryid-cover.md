---
title: "DELETE /admin-api/category/{categoryId}/cover"
weight: 2
---

# DELETE /admin-api/category/{categoryId}/cover
## Details
* **Component** : Core
* **Status** : Automated
* **Automated on** : 9.1.x, 9.0.x
* **Scenario** : https://forge.prestashop.com/browse/TEST-12173
* **Test** : https://github.com/PrestaShop/PrestaShop/tree/develop/tests/UI/campaigns/functional/API/02_endpoints/03_category/02_deleteCategoryIdCover.ts
...
| Request with method DELETE the endpoint "https://[url of your shop]/admin-api/category/\{categoryId}/cover" | The HTTP code is 204. |

---
title: "FO - Download invoice from orders list"
weight: 3
---

# FO - Download invoice from orders list
## Steps
...
| Go to FO > Click on your user name account in the header (previously connected with the pre-condition below) | "Your account" page is well displayed |

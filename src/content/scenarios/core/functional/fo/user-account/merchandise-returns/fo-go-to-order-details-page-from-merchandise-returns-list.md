---
title: "FO - Go to order details page from merchandise returns list"
weight: 2
---

# FO - Go to order details page from merchandise returns list
## Steps
...
| Click on your user name account in the header | * "Your account" page is well displayed<br> * A merchandise returns tab is displayed |

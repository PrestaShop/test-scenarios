...
| *CLI Delete Rollback*  <br><br>Launch the command " php bin/console backup:delete admin-dev" | Terminal display a choice of backup between 0 and 2, the number 3 is to exit the process |
| Launch the command "3" | Your terminal should act like there is none command launch |

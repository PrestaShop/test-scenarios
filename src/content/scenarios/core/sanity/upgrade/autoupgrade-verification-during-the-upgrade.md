...
| Wait until the upgrade of modules | * When it's the turn of ps_faceted_search it should be cutted in 5 different part of upgrade<br> * After the upgrade of module, You should have the green notification for the end of the upgrade |

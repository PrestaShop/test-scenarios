---
title: "Autoupgrade - Web Version - Configuration settings for updates part "
weight: 19
---

# Autoupgrade - Web Version - Configuration settings for updates part 
## Details
* **Component** : Core
* **Status** : [TEST] IN PROGRESS
* **Scenario** : https://prestashop-jira.atlassian.net/browse/TEST-5649
...
| Click on toggle of "Disable all overrides" | Disable all overrides is enabled |
...
| Search for "mcp". | Prestashop MCP is displayed and disabled |
| return in account.txt files already open | Files inform that it's modified and don't keep the previous modification |
| Go to Advanced Parameters > Performance. | Disable all overides is enabled on debug mode part |

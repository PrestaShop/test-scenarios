...
| Check "Size" and "Color" checkboxes > Click on "Generate XX combinations" button > Click on "Cancel" button or the close icon of the modal | * All attributes is added on the empty field<br> * "Successfully generated 56 combinations" is displayed<br> * The modal is well removed |
...
| Edit the product by changing combinations data on "Combinations" tab > Add a quantity on a combination on the field quantity > Click on "Save list" button at the end of the combinations list | * "Cancel" / "Reset" / "Save list" buttons are displayed<br> * "Update successful" message is displayed |

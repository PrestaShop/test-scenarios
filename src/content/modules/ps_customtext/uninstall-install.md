...
| Click on "uninstall" and confirm the uninstall message by clicking on ok | The message "Notice!<br>L'action Uninstall sur le module ps_customtext a réussi." should appear in green to indicate that the module is uninstalled |
...
| Click on install | The message "Notice!<br>L'action Install sur le module ps_customtext a réussi." should appear in green to indicate that the module is installed |
